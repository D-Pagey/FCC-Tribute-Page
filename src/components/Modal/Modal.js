    ...
    return (
      <div className="modal-container">
              ...
              <dialog className="modal-about" open={this.state.modal}>
                ...
                <p className="modal-text">This is a basic Front End 
                Developer project from the FreeCodeCamp curriculum. The user 
                stories to be completed are:</p>
                <ul className="user-stories">
                  <li className="story">I can view a tribute page with an image 
                  and text.</li>
                  <li className="story">I can click on a link that will take me 
                  to an external website with further information on the topic.</li>
                </ul>
                <p className="modal-text">This project was coded in React using 
                Create-React-App. The code can be seen on 
                <a href="https://github.com/D-Pagey/Tribute" target="_blank" 
                rel='noreferrer noopener' className='ghLink'> Github</a>.</p>
              </dialog>
      </div>
    )
  }
